...
void setup() {
  ...
  scheduler.addJob(Schedule::sunrise(), SchedulerJobMode::Inline, &astroCallback, (void*)"sunrise");
  scheduler.addJob(Schedule::sunset(15), SchedulerJobMode::Inline, &astroCallback, (void*)"sunset +15m");
  scheduler.addJob(Schedule::moonPhase(MoonPhaseName::LastQuarter, 2),
                   SchedulerJobMode::Inline,
                   &astroCallback,
                   (void*)"last quarter");
  scheduler.addJob(Schedule::moonIlluminationPercent(75.0, 0.5),
                   SchedulerJobMode::Inline,
                   &astroCallback,
